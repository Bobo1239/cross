...
main() {
    ...
    cd gcc
    sed -i'' -e 's|ftp://gcc.gnu.org|http://gcc.gnu.org|g' ./contrib/download_prerequisites
    ./contrib/download_prerequisites
    local patches=(
        ftp://ftp.netbsd.org/pub/pkgsrc/pkgsrc-2017Q4/pkgsrc/lang/gcc5/patches/patch-libstdc++-v3_config_os_bsd_netbsd_ctype__base.h
        ftp://ftp.netbsd.org/pub/pkgsrc/pkgsrc-2017Q4/pkgsrc/lang/gcc5/patches/patch-libstdc++-v3_config_os_bsd_netbsd_ctype__configure__char.cc
    )
